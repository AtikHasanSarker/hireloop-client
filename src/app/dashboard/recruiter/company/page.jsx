...
import { listItemClasses, popoverClasses, selectBoxClass, textAreaClass, textInputClass, triggerClasses } from "@/components/style";
...
export default function CompanyProfile() {
  ...
  const handleLogoUpload = async (e) => {
    ...
    try {
      // Replace YOUR_IMGBB_API_KEY with your actual ImgBB key
        ...
        <div className="border border-zinc-800 bg-zinc-950 rounded-2xl p-12 text-center space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-zinc-400 text-sm max-w-sm mx-auto">
              You haven't set up a company profile yet. Register your business
